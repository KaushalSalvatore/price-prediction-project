...
@usedcar_blueprint.route("/usedcarprice")
@cross_origin()
def home():
    return render_template('car_index.html')

@usedcar_blueprint.route("/usedcarpredict", methods=["GET","POST"])
@cross_origin()
def predict():
    #CAR BRAND
    AMBASSADOR=0
...
#PREDICTION
        ...
        return render_template('predicted_price.html',prediction_text="Your car's price should be Rs. {} lakhs. This price may change depending on the condition of the car.".format(output))
